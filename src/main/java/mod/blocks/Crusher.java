...
public class Crusher extends Block implements ITileEntityProvider {
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn,
		...
		playerIn.openGui(Reference.modid, GuiHandlerCrusher.getGuiId(), worldIn, pos.getX(), pos.getY(), pos.getZ());
		playerIn.addStat(ModElements.open_crusher_gui);
		return true;
	}
	...
	public static void setState(boolean active, World worldIn, BlockPos pos) {
		...
		worldIn.setBlockState(pos,
				ModElements.crusher.getDefaultState().withProperty(FACING, iblockstate.getValue(FACING)), 3);
		worldIn.setBlockState(pos,
				ModElements.crusher.getDefaultState().withProperty(FACING, iblockstate.getValue(FACING)), 3);
		if (tileentity != null) {
			tileentity.validate();
	...
	public ItemStack getItem(World worldIn, BlockPos pos, IBlockState state) {
		return new ItemStack(ModElements.crusher);
	}
